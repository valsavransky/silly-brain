  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <GameHeader
        ...
        subtitle="Think of something — the guessing genie will try to read your mind!"
      />
            ...
            <AnimatePresence>
              ...
              {phase === "asking" && turn && (
                ...
                >
                  ...
                  >
                    {turn.isGuess && <span className="block text-xs uppercase tracking-wide text-slate-600">✨ The genie makes a guess! ✨</span>}
                    {turn.question}
                  </p>
                </motion.div>
              )}
...
function AnswerBtn({
  ...
  return (
    <button
      onClick={onClick}
      className={`btn-chunky min-h-14 px-4 rounded-2xl text-white font-display font-bold text-lg ${className}`}
    >
      {label}
    </button>
  );
